...
| PRD-05 | LAP LTV by what is pledged | residential 60%–70% · commercial 50%–60% | A shop is slower to sell than a house and its valuation is softer. Ravi's premises are commercial. **Adversarial review found only the top of every LTV band was read** — the bottom was decoration a reviewer could change and watch nothing happen. Both ends now bound the amount range, because a lender may advance either share against the same asset. | Industry practice — NEEDS VERIFICATION |
